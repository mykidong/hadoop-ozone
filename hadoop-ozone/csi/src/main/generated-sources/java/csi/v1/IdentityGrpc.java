...
public final class IdentityGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<csi.v1.Csi.GetPluginInfoRequest,
      csi.v1.Csi.GetPluginInfoResponse> getGetPluginInfoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetPluginInfo",
      requestType = csi.v1.Csi.GetPluginInfoRequest.class,
      responseType = csi.v1.Csi.GetPluginInfoResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<csi.v1.Csi.GetPluginInfoRequest,
      csi.v1.Csi.GetPluginInfoResponse> getGetPluginInfoMethod() {
    io.grpc.MethodDescriptor<csi.v1.Csi.GetPluginInfoRequest, csi.v1.Csi.GetPluginInfoResponse> getGetPluginInfoMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<csi.v1.Csi.GetPluginCapabilitiesRequest,
      csi.v1.Csi.GetPluginCapabilitiesResponse> getGetPluginCapabilitiesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetPluginCapabilities",
      requestType = csi.v1.Csi.GetPluginCapabilitiesRequest.class,
      responseType = csi.v1.Csi.GetPluginCapabilitiesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<csi.v1.Csi.GetPluginCapabilitiesRequest,
      csi.v1.Csi.GetPluginCapabilitiesResponse> getGetPluginCapabilitiesMethod() {
    io.grpc.MethodDescriptor<csi.v1.Csi.GetPluginCapabilitiesRequest, csi.v1.Csi.GetPluginCapabilitiesResponse> getGetPluginCapabilitiesMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<csi.v1.Csi.ProbeRequest,
      csi.v1.Csi.ProbeResponse> getProbeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Probe",
      requestType = csi.v1.Csi.ProbeRequest.class,
      responseType = csi.v1.Csi.ProbeResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<csi.v1.Csi.ProbeRequest,
      csi.v1.Csi.ProbeResponse> getProbeMethod() {
    io.grpc.MethodDescriptor<csi.v1.Csi.ProbeRequest, csi.v1.Csi.ProbeResponse> getProbeMethod;
